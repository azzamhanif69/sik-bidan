        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="/admin/obat/{{ $obat->id }}">
                    ...
                    @csrf
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label required-label" for="nama_obat">Nama Obat</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('nama_obat') is-invalid @enderror"
                                id="nama_obat" placeholder="Masukkan Nama Obat" name="nama_obat" autofocus
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label required-label" for="sediaan">Sediaan</label>
                        <div class="col-sm-10">
                            <select class="form-select @error('sediaan') is-invalid @enderror" aria-label="sediaan"
                                ...
                                <option id="tablet" @if (old('sediaan', $obat->sediaan) == 'Tablet') selected @endif value="Tablet">
                                    Tablet</option>
                                <option id="kapsul" @if (old('sediaan', $obat->sediaan) == 'Kapsul') selected @endif value="Kapsul">
                                    Kapsul</option>
                                <option id="sirup" @if (old('sediaan', $obat->sediaan) == 'Sirup') selected @endif value="Sirup">
                                    Sirup</option>
                            </select>
                            @error('sediaan')
                                <div class="invalid-feedback">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label required-label" for="dosis">Dosis Obat</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('dosis') is-invalid @enderror" id="dosis"
                                placeholder="Masukkan Nama Obat" name="dosis" autofocus
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label required-label" for="satuan">satuan</label>
                        <div class="col-sm-10">
                            <select class="form-select @error('satuan') is-invalid @enderror" aria-label="satuan"
                                ...
                                <option id="g" @if (old('satuan', $obat->satuan) == 'g') selected @endif value="g">
                                    g</option>
                                <option id="mg" @if (old('satuan', $obat->satuan) == 'mg') selected @endif value="mg">
                                    mg</option>
                                <option id="mcg" @if (old('satuan', $obat->satuan) == 'mcg') selected @endif value="mcg">
                                    mcg</option>
                            </select>
                            @error('satuan')
                                <div class="invalid-feedback">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control @error('stok') is-invalid @enderror" id="stok"
                                placeholder="Masukkan Stok" name="stok" autofocus value="{{ old('stok', $obat->stok) }}">
                            @error('stok')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
