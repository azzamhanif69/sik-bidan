        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="/admin/pasien/{{ $pasien->id }}">
                    ...
                    {{-- <input type="hidden" name='code' value="{{ old('code', $pasien->code) }}" id="codeEditPatient"> --}}
                    {{-- <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('address') is-invalid @enderror"
                                ...
                                value="{{ old('address', $pasien->address) }}">
                            @error('address')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-2">
                            <input type="date" id="tanggalLahir"
                                ...
                                name="birth" autofocus value="{{ old('birth', $pasien->birth) }}" onfocus="hitungUmur()">
                            @error('birth')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input name="date_of_birth"id="hasilUmur" type="text"
                                ...
                                placeholder="" value="{{ old('date_of_birth', $pasien->date_of_birth) }}" readonly>
                            @error('date_of_birth')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select class="form-select @error('gender') is-invalid @enderror"
                                ...
                                <option id="laki-laki" @if (old('gender', $pasien->gender) == 'Laki-laki') selected @endif value="Laki-laki">
                                    Laki-Laki</option>
                                <option id="perempuan" @if (old('gender', $pasien->gender) == 'Perempuan') selected @endif value="Perempuan">
                                    Perempuan</option>
                            </select>
                            @error('gender')
                                <div class="invalid-feedback">
